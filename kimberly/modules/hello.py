...
@kimberly.on_message(filters.regex(regex_salute))
@kimberly.on_edited_message(filters.regex(regex_salute))
async def hello(client, message):
    answer = build_reply(message, salute_answers)
    await message.reply_text(answer, quote=False)

@kimberly.on_message(filters.regex(regex_gn))
@kimberly.on_edited_message(filters.regex(regex_gn))
